...
class Kernel_estimation(nn.Module):
    def __init__(self, kernel_size) -> None:
        ...
        self.pad = torch.nn.ReplicationPad2d(
            [(self.kernel_size - 1) // 2, (self.kernel_size - 1) // 2, (self.kernel_size - 1) // 2, (self.kernel_size - 1) // 2])
    ...
    def forward(self, input, kernel):
        ...
        kernel = kernel.reshape(
            N, H, W, self.kernel_size, self.kernel_size, -1)
