...
######################################################################
# loss functions
from new_method.utils.loss import deblurring_loss
    ...
    def update_model(self, model):
        for name, param in model.named_parameters():
            ...
            if param.grad is not None:
                self.writer.add_histogram(name + '/grad', param.grad.clone().cpu().data.numpy(), 0)
...
from new_method.utils.utils import generation_viz
